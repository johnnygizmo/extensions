...
class COLORHARMONY_PT_shader_panel(bpy.types.Panel):
    bl_label = "Color Harmony Tools"
    bl_idname = "COLORHARMONY_PT_shader_panel"
    
    #panel is shown in the side panel of the shader editor
    bl_space_type = "NODE_EDITOR"
    bl_region_type = "UI"
    bl_category = "Color Harmony"
    ...
    def draw(self, context):
        ...
        if mat and mat.use_nodes:
            ...
            (head,body) = layout.panel("Tools",default_closed=False)
