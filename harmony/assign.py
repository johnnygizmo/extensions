...
class COLORHARMONY_OT_ApplySelectedPaletteColor(bpy.types.Operator):
...
def register():
    bpy.utils.register_class(COLORHARMONY_OT_ApplySelectedPaletteColor) # Register the new operator

def unregister():
    bpy.utils.unregister_class(COLORHARMONY_OT_ApplySelectedPaletteColor) # Unregister the new operator
